...
public class BatchStreamBq {
  ...
  public static void runWritePendingStream()
    ...
    String datasetName = "Adjust_realtime";
    ...
    try {
      ...
      for (int i = 0; i < 2; i++) {
        ...
        for (int j = 0; j < 10; j++) {
          ...
          record.put("name", String.format("batch-record %03d-%03d", i, j));
          jsonArr.put(record);
        }
  ...
  public static class DataWriter {
    ...
    public void initialize(TableName parentTable, BigQueryWriteClient client)
